...
namespace Eng {
    class ResourceManager {
        ...
        std::unordered_map<std::string, MaterialUboData> materials;
    ...
    public:
        ...
        ResourceManager(Device* _device, EntitySystem* _entitySystem, const unsigned int& _maxTextures, const unsigned int& _minUniformBufferOffsetAlignment);
        ...
        std::vector<MaterialUboData> materialBufferData;
        ...
        void storeMaterial(const std::string& materialName, const MaterialUboData& data);
